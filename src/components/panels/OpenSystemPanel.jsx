        ...
        <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 space-y-1.5">
          <div className="flex justify-between items-center text-xs">
            ...
            <button onClick={() => applyDecoherenceStep('t1')}
              className="px-2 py-0.5 rounded bg-rose-950/60 border border-rose-500/40 text-[11px] text-rose-300">Step Δt</button>
          </div>
        ...
        <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 space-y-1.5">
          <div className="flex justify-between items-center text-xs">
            ...
            <button onClick={() => applyDecoherenceStep('t2')}
              className="px-2 py-0.5 rounded bg-indigo-950/60 border border-indigo-500/40 text-[11px] text-indigo-300">Step Δt</button>
          </div>
          <p className="text-[11px] text-slate-400">
        ...
        <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 space-y-1.5">
          <div className="flex justify-between items-center text-xs">
            ...
            <button onClick={() => applyDecoherenceStep('depolar')}
              className="px-2 py-0.5 rounded bg-amber-950/60 border border-amber-500/40 text-[11px] text-amber-300">Step Δt</button>
          </div>
          <p className="text-[11px] text-slate-400">
