  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 space-y-4">
      <div className="glass-panel p-3.5 rounded-xl border border-cyan-500/20 space-y-2">
        ...
        <div className="p-2 rounded bg-slate-900 border border-slate-800 text-xs font-mono text-purple-200">
      ...
      <div className="glass-panel p-3.5 rounded-xl border border-slate-800 space-y-3">
        <div className="text-[13px] font-semibold text-slate-200">Decoherence Channels:</div>

        {/* T1 Amplitude Damping */}
        <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 space-y-1.5">
          <div className="flex justify-between items-center text-[13px]">
            <span className="font-bold text-cyan-300">T₁ Amplitude Damping:</span>
            <button onClick={() => applyDecoherenceStep('t1')}
              className="px-2 py-0.5 rounded bg-cyan-950/60 border border-cyan-500/40 text-xs text-cyan-300">Step Δt</button>
          </div>
        ...
        <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 space-y-1.5">
          <div className="flex justify-between items-center text-[13px]">
            <span className="font-bold text-violet-300">T₂* Pure Dephasing:</span>
            <button onClick={() => applyDecoherenceStep('t2')}
              className="px-2 py-0.5 rounded bg-violet-950/60 border border-violet-500/40 text-xs text-violet-300">Step Δt</button>
          </div>
          <p className="text-xs leading-relaxed text-slate-400">
        ...
        <div className="p-2.5 rounded-lg bg-slate-900 border border-slate-800 space-y-1.5">
          <div className="flex justify-between items-center text-[13px]">
            <span className="font-bold text-slate-100">Depolarizing Channel:</span>
            <button onClick={() => applyDecoherenceStep('depolar')}
              className="px-2 py-0.5 rounded bg-slate-800 border border-slate-500/50 text-xs text-slate-100">Step Δt</button>
          </div>
          <p className="text-xs leading-relaxed text-slate-400">
        ...
        <button onClick={purifyState}
          className="w-full py-1.5 rounded-lg bg-slate-800 hover:bg-slate-700 text-[13px] font-medium text-cyan-300 transition">
          Purify State (|r⃗| → 1.0)
        </button>
      </div>
    </div>
