  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 space-y-4">
      <div className="glass-panel p-3.5 rounded-xl border border-cyan-500/20 space-y-2">
        ...
        <div className="p-2 rounded bg-slate-900 border border-cyan-900/40 text-xs font-mono text-cyan-300">
      ...
      <div className="glass-panel p-3 rounded-xl border border-slate-800 space-y-2">
        <div className="text-[13px] font-bold text-slate-200">Interactive Circuit Protocol:</div>
          ...
          {[1, 2, 3, 4].map(step => {
            ...
            return (
              <button key={step} onClick={() => execKickbackStep(step)}
                className={`w-full text-left p-2 rounded-lg border text-[13px] transition ${
                  isActive
      ...
      <div ref={statusRef} className="p-3 rounded-xl bg-slate-900/90 border border-slate-800 text-xs text-slate-300 leading-relaxed">
