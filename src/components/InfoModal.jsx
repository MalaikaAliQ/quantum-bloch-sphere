  ...
  return (
    <div className="fixed inset-0 bg-black/85 backdrop-blur-md z-50 flex items-center justify-center p-4">
      <div className="glass-panel w-full max-w-4xl max-h-[85vh] rounded-2xl border border-cyan-500/30 flex flex-col overflow-hidden shadow-2xl">
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-[13px] text-slate-300 leading-relaxed font-sans">
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-900/60 flex justify-end">
          <button onClick={onClose} className="px-4 py-2 rounded-lg bg-cyan-700 hover:bg-cyan-600 text-white font-medium text-[13px] transition">
            Close Guide
          </button>
        </div>
      </div>
